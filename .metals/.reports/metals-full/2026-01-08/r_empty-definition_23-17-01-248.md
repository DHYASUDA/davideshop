error id: file:///C:/Users/david/Desktop/davideshop/src/main/java/com/example/davideshop/controller/productController.java:
...
public class productController {
    ...
    public ResponseEntity<productEntity> updateProduct(@PathVariable("id") Long@@ id){
        productEntity product = productService.updateProductInfo(request);
        return ResponseEntity.ok(product);
